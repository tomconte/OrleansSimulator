...
namespace GrainInterfaces
{
    ...
    public class SimulatorGrainFactory
    {
        ...
        internal class SimulatorGrainReference : Orleans.GrainReference, ISimulatorGrain, Orleans.IAddressable
        {
            ...
            public System.Threading.Tasks.Task<string> StartSimulation(string name, GrainInterfaces.IManagerGrain managerGrain)
            {

                AsyncValue<object> invoke = base.InvokeMethod( 870213720, new object[] {name, managerGrain is GrainBase ? ManagerGrainFactory.Cast(managerGrain.AsReference()) : managerGrain});
                return invoke.ContinueWith<System.String>( (object returnedValue) =>
                {
                    
                    return (System.String) returnedValue;
                }).AsTask();
            }
            ...
            public AsyncCompletion Invoke(IAddressable grain, int interfaceId, int methodId, object[] arguments)
            {
                ...
                switch (interfaceId)
                {
                    case -788366214:  // ISimulatorGrain
                        ...
                        {
                            case 870213720: 
                                return AsyncValue<String>.FromTask(((ISimulatorGrain)grain).StartSimulation((String)arguments[0], (IManagerGrain)arguments[1]));
                            case -1165576126: 
    ...
    public class ManagerGrainFactory
    {
        ...
        internal class ManagerGrainReference : Orleans.GrainReference, IManagerGrain, Orleans.IAddressable
        {
            ...
            public System.Threading.Tasks.Task StartSimulators(GrainInterfaces.ISimulationObserver observer)
            {
GrainFactoryBase.CheckGrainObserverParamInternal(observer);

                AsyncValue<object> invoke = base.InvokeMethod( 1611159850, new object[] {observer is GrainBase ? SimulationObserverFactory.Cast(observer.AsReference()) : observer});
                return invoke.AsTask();
            }
            ...
            public AsyncCompletion Invoke(IAddressable grain, int interfaceId, int methodId, object[] arguments)
            {
                ...
                switch (interfaceId)
                {
                    case -1211692310:  // IManagerGrain
                        ...
                        {
                            case 1611159850: 
                                return AsyncCompletion.FromTask(((IManagerGrain)grain).StartSimulators((ISimulationObserver)arguments[0]));
                            case -861552654: 
